...
const Hero: React.FC = () => {
  return (
    <section className="flex h-screen w-full flex-col items-center justify-center max-md:max-w-full bg-gradient-to-t from-[#F0FBFD] to-[#FFFFFF]">
      <div className="max-w-[1440px] justify-center items-stretch flex w-full flex-col overflow-hidden gap-28 px-2.5 py-[50px] max-md:max-w-full">
        ...
        <div className="flex w-full justify-center mt-28 max-md:mt-10">
