...
const Hero: React.FC = () => {
  return (
    <section className="flex min-h-[calc(100vh-88px)] sm:min-h-[calc(100svh-88px)] md:min-h-[calc(100dvh-88px)] w-full flex-col items-center justify-center max-md:max-w-full bg-gradient-to-t from-[#F0FBFD] to-[#FFFFFF]">
