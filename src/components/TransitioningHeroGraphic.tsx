    ...
    <div className="w-full max-w-[1200px] mx-auto flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="flex justify-between w-full px-4">
        <div className="flex-1 text-center">
          <div className="text-[#5A9BA6] text-lg font-medium">REAL WORLD DATA</div>
        </div>
        <div className="flex-1 text-center">
          <div className="text-[#5A9BA6] text-lg font-medium">REAL BEHAVIOUR</div>
        </div>
        <div className="flex-1 text-center">
          <div className="text-[#5A9BA6] text-lg font-medium">REAL INSIGHT</div>
        </div>
      </div>
    </div>
  );
